...
<div class="page-form">
  ...
  {#if data.pageError}
    <div class="error">
      <strong>Error:</strong> {data.pageError}
      <p><a href="/{data.username}" class="btn btn-secondary">Go back</a></p>
    </div>
  {:else if data.page}
    {#if error}
      <div class="error">
    ...
    <form on:submit|preventDefault={handleSubmit}>
      ...
      <div class="form-group checkbox-group">
        <input
          ...
          disabled={saving || deleting}
        />
        <label for="published"> Publish page (make it visible to you when browsing) </label>
      </div>
      ...
      <div class="form-actions">
        ...
        <a href="/{data.username}/{data.page?.path ?? ''}" class="btn btn-secondary">Cancel</a>
